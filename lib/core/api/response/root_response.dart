// File: common/services/root_response.dart

import 'package:dio/dio.dart';
import 'package:good_food_app/core/api/exceptions/root_exception.dart';

import '../../log/loggers.dart';

class RootResponse {
  static const String TAG = '[RootResponse]';
  ...
  static void _logAndThrowWarning(String message, int code) {
    ...
    throw RootException(message: message, code: code.toString());
  }
