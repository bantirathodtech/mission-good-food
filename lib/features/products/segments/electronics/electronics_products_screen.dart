...
// class ElectronicsProductsScreen extends StatelessWidget {
//   const ElectronicsProductsScreen({super.key, required String themeName});
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Electronics Products'),
